...
const (
	Query_Params_FullMethodName  = "/todoexercise.todo.Query/Params"
	Query_Task_FullMethodName    = "/todoexercise.todo.Query/Task"
	Query_TaskAll_FullMethodName = "/todoexercise.todo.Query/TaskAll"
)
