...
func init() {
	...
	md_Task = File_todoexercise_todo_task_proto.Messages().ByName("Task")
...
func (x *Task) slowProtoReflect() protoreflect.Message {
	mi := &file_todoexercise_todo_task_proto_msgTypes[0]
...
func (x *fastReflection_Task) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "todoexercise.todo.Task.id":
		return x.Id != uint64(0)
	case "todoexercise.todo.Task.title":
		return x.Title != ""
	case "todoexercise.todo.Task.description":
		return x.Description != ""
	case "todoexercise.todo.Task.completed":
		return x.Completed != false
	case "todoexercise.todo.Task.creator":
		return x.Creator != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: todoexercise.todo.Task"))
		}
		panic(fmt.Errorf("message todoexercise.todo.Task does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Task) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message todoexercise.todo.Task does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Task) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "todoexercise.todo.Task.id":
		panic(fmt.Errorf("field id of message todoexercise.todo.Task is not mutable"))
	case "todoexercise.todo.Task.title":
		panic(fmt.Errorf("field title of message todoexercise.todo.Task is not mutable"))
	case "todoexercise.todo.Task.description":
		panic(fmt.Errorf("field description of message todoexercise.todo.Task is not mutable"))
	case "todoexercise.todo.Task.completed":
		panic(fmt.Errorf("field completed of message todoexercise.todo.Task is not mutable"))
	case "todoexercise.todo.Task.creator":
		panic(fmt.Errorf("field creator of message todoexercise.todo.Task is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: todoexercise.todo.Task"))
		}
...
func (x *fastReflection_Task) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in todoexercise.todo.Task", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Task) Descriptor() ([]byte, []int) {
	return file_todoexercise_todo_task_proto_rawDescGZIP(), []int{0}
}
...
var File_todoexercise_todo_task_proto protoreflect.FileDescriptor

var file_todoexercise_todo_task_proto_rawDesc = []byte{
	0x0a, 0x1c, 0x74, 0x6f, 0x64, 0x6f, 0x65, 0x78, 0x65, 0x72, 0x63, 0x69, 0x73, 0x65, 0x2f, 0x74,
	0x6f, 0x64, 0x6f, 0x2f, 0x74, 0x61, 0x73, 0x6b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x11,
	0x74, 0x6f, 0x64, 0x6f, 0x65, 0x78, 0x65, 0x72, 0x63, 0x69, 0x73, 0x65, 0x2e, 0x74, 0x6f, 0x64,
	0x6f, 0x22, 0x86, 0x01, 0x0a, 0x04, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x09, 0x52, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x42, 0xab, 0x01, 0x0a, 0x15, 0x63,
	0x6f, 0x6d, 0x2e, 0x74, 0x6f, 0x64, 0x6f, 0x65, 0x78, 0x65, 0x72, 0x63, 0x69, 0x73, 0x65, 0x2e,
	0x74, 0x6f, 0x64, 0x6f, 0x42, 0x09, 0x54, 0x61, 0x73, 0x6b, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50,
...
var (
	file_todoexercise_todo_task_proto_rawDescOnce sync.Once
	file_todoexercise_todo_task_proto_rawDescData = file_todoexercise_todo_task_proto_rawDesc
)

func file_todoexercise_todo_task_proto_rawDescGZIP() []byte {
	file_todoexercise_todo_task_proto_rawDescOnce.Do(func() {
		file_todoexercise_todo_task_proto_rawDescData = protoimpl.X.CompressGZIP(file_todoexercise_todo_task_proto_rawDescData)
	})
	return file_todoexercise_todo_task_proto_rawDescData
}

var file_todoexercise_todo_task_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_todoexercise_todo_task_proto_goTypes = []interface{}{
	(*Task)(nil), // 0: todoexercise.todo.Task
}
var file_todoexercise_todo_task_proto_depIdxs = []int32{
...
func init() { file_todoexercise_todo_task_proto_init() }
func file_todoexercise_todo_task_proto_init() {
	if File_todoexercise_todo_task_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_todoexercise_todo_task_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Task); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_todoexercise_todo_task_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_todoexercise_todo_task_proto_goTypes,
		DependencyIndexes: file_todoexercise_todo_task_proto_depIdxs,
		MessageInfos:      file_todoexercise_todo_task_proto_msgTypes,
	}.Build()
	File_todoexercise_todo_task_proto = out.File
	file_todoexercise_todo_task_proto_rawDesc = nil
	file_todoexercise_todo_task_proto_goTypes = nil
	file_todoexercise_todo_task_proto_depIdxs = nil
}
